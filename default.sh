...
echo "Quick start:"
echo "  R                        # Start R"
echo "  targets::tar_make()      # Run pipeline"
echo ""
echo "  # List CoMMpass S3 bucket (no credentials needed)"
echo "  aws s3 ls --no-sign-request s3://gdc-mmrf-commpass-phs000748-2-open/"
echo ""
