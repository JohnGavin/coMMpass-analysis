...
- Direct access to CoMMpass data via AWS S3, GDC, and MMRF Researcher
  Gateway
- **[Interactive
  Dashboard](https://johngavin.github.io/coMMpass-analysis/dashboard.html)** -
  Explore analysis results in your browser
...
Explore CoMMpass analysis results directly in your browser: - Quality
Control metrics and visualizations - Differential Expression analysis
(volcano plots, MA plots, heatmaps) - Survival Analysis (Kaplan-Meier
curves, Cox regression) - Pathway Analysis (enrichment plots, GSEA)

The dashboard runs entirely in your browser using WebAssembly - no R
server required!
...
- [GDC Data
  Portal](https://portal.gdc.cancer.gov/projects/MMRF-COMMPASS) - 995
  cases, 34,109 files
...
- [MMRFBiolinks (Briefings in Bioinformatics
  2021)](https://pubmed.ncbi.nlm.nih.gov/33821961/)
- [Mount Sinai Immune Cell
  Atlas](https://www.mountsinai.org/about/newsroom/2026/mount-sinai-researchers-help-create-largest-immune-cell-atlas-of-bone-marrow-in-multiple-myeloma-patients)
