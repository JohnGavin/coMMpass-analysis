...
safe_tar_read <- function(name) {
  ...
  htmltools::div(
    style = "background:#6c757d;color:white;padding:1em;border-radius:4px;margin:1em 0;",
    htmltools::strong(paste0("[", name, "]")),
    " \u2014 Run targets::tar_make() locally to generate this output."
  )
}
```
